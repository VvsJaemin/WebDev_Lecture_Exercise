...
public class DummyGenerator {
	...
	public String makeBirthday() {
		...
		if (year % 4 == 0 && year % 100 != 0 || year == 0 && month == 2) {
			...
			return year + "년" + month + "월" + leapdate + "일";
			...
			if (month == 1 || month == 3 || month == 5 || 
				...
				return year + "년" + month + "월" + date2 + "일";
				
			} else if (month == 4 || month == 6 || month == 9 || month == 11) {
				
				int date3 = rangeRandom.apply(1, 30);
				return year + "년" + month + "월" + date3 + "일";
				
			} else {
				
				int date4 = rangeRandom.apply(1, 28);
				return year + "년" + month + "월" + date4 + "일";
			}
	...
	public String makeGender() {
		List<String> arr = Arrays.asList(c, "F");
		shuffle(arr);
		return arr.get(0);
	}

	public String makeRegdate() {
		int reg = regdate.apply(1, 30);
		int reg2 = regdate.apply(1, 29);
		int reg3 = regdate.apply(1, 28);
		int reg4 = regdate.apply(1, 31);
