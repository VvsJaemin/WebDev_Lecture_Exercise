...
//         List<String>sname=Arrays.asList("가", "강", "건", "경", "고", "관", "광", "구", "규", "근", "기", "길", "나", "남", "노",
...
//         "롱", "평", "늘", "늬", "랑", "얀", "향", "울", "련");
//         List<String>tname = Arrays.asList("가", "강", "건", "경", "고", "관", "광", "구", "규", "근", "기", "길", "나", "남", "노",
//         "누", "다", "단", "달", "담", "대", "덕", "도", "동", "두", "라", "래", "로", "루", "리", "마", "만", "명", "무", "문", "미",
//         "민", "바", "박", "백", "범", "별", "병", "보", "빛", "사", "산", "상", "새", "서", "석", "선", "설", "섭", "성", "세", "소",
//         "솔", "수", "숙", "순", "숭", "슬", "승", "시", "신", "아", "안", "애", "엄", "여", "연", "영", "예", "오", "옥", "완", "요",
//         "용", "우", "원", "월", "위", "유", "윤", "율", "으", "은", "의", "이", "익", "인", "일", "잎", "자", "잔", "장", "재", "전",
...
//         shuffle(sname);
//         shuffle(tname);
//         return fname.get(0) + sname.get(0)+ tname.get(0);
...
//         List<String> ls = Arrays.asList("@naver.com", "@gmail.com", "@nate.com");
//         return ls.get(0);
//     }

//     public String makeGender(){
//         List<String> gen = Arrays.asList("M", "F");
//         shuffle(gen);
...
//         return myCalender(1970, 2000);
//     }

//     public String myCalender(int start, int end){
...
// 		return new User(makeName(), "1", makeUsername(), makeEmail(),  
// 				makeBirthday(), makeGender(), makeRegdate();)
